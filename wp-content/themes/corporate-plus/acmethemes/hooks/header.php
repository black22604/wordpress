                ...
                <div class="main-navigation navbar-collapse collapse">
                    ...
                    ?>
                        <div class="user-login">
                            <a class="cart-contents" href="<?php echo WC()->cart->get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' , 'corporate-plus' ); ?>"><?php echo sprintf (_n( '%d item', '%d items', WC()->cart->cart_contents_count ), WC()->cart->cart_contents_count ); ?> - <i class="fa fa-shopping-cart"></i> <?php echo WC()->cart->get_cart_total(); ?></a>
                            <?php if ( is_user_logged_in() ) { ?>
                                <a class="button" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My Account','corporate-plus'); ?>"><?php _e('My Account','corporate-plus'); ?></a>
                            <?php }
                            else { ?>
                                <a class="button" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','corporate-plus'); ?>"><?php _e('Login / Register','corporate-plus'); ?></a>
                            <?php } ?>
                        </div>
